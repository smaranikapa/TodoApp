...
export const ShowTask = (props) => {
     ...
     return (
          <Flex gap={[1, 1, 2, 2]} flexDir="column" className="container">
               <Flex gap={[1, 1, 2, 2]} justifyContent="center" className="container" size={["xs", "sm", "md"]}>
                    {props.time && (
                    ...
                    <Badge 
                         bg={
                              props.priority === "high"
                                   ? "#00ff1fd4" // Green color for high priority
                                   : props.priority === "medium"
                                        ? "#FFA500" // Orange color for medium priority
                                        : "#FF0000" // Red color for low priority
                         }
                         variant="solid"
                    >
                         {props.priority}
